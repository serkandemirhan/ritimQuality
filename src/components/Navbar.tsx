...
export type NavTab = 'work' | 'operator' | 'control-plans' | 'products' | 'spc' | 'logs' | 'users' | 'subscription';
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex items-center gap-2">
                <span className="rounded-md bg-blue-950 px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wider text-blue-300 ring-1 ring-blue-800/70">{company.planId}</span>
                <span className={`text-[10px] font-semibold ${company.subscriptionStatus === 'active' ? 'text-emerald-400' : 'text-amber-400'}`}>
                  {company.subscriptionStatus === 'active' ? 'Aktif' : 'Deneme'}
                </span>
              </div>
            </div>
          </div>
