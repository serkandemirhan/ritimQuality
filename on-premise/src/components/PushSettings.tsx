...
export function PushSettings(){
  ...
  const enable=async()=>{
    setBusy(true);try{
      ...
      const config=await OnPremApi.pushConfig() as {enabled:boolean;publicKey:string};if(!config.enabled)throw new Error('Push hizmeti sunucuda henüz etkinleştirilmemiş. Uygulama içi bildirimler aktif.');
